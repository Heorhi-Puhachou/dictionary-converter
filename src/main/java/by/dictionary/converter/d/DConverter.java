package by.dictionary.converter.d;
...
public class DConverter implements Converter {
    ...
    public List<Record> convert(String id, String inputDictonary) throws URISyntaxException {
        ...
        readConvertWriteGlossary(aNarRecords, "generated/d/narkam.json");
        readConvertWriteGlossary(aTarRecords, "generated/d/tarask.json");
        readConvertWriteGlossary(aLacRecords, "generated/d/lacink.json");
